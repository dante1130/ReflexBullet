...
// prefer to have all define start with ES_ as easy sound similar to GL_ for openGL
/**
...
#define ES_ONCE	0
  ...
  /**
   * class CSoundTime: The is the time conversion from min:sec:ms into int value for SDL library
   *
...
private:
	...
	void ConvertToMinSecMs();
	Uint32 ConvertToSDLTime();
};

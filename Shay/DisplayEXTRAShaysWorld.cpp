...
void DisplayExtraArea::DisplayEnvironment()
{
	glPushMatrix();
...
void DisplayExtraArea::DisplayChairs()
{
...
void DisplayExtraArea::DisplayBenches()
{
	// Bench 1 (Furthest)
	glPushMatrix();
...
void DisplayExtraArea::DisplaySmallTable()
{
	// Diagonal chair 1
	glPushMatrix();
...
void DisplayExtraArea::DisplayBigTable()
{
	glPushMatrix();
...
void DisplayExtraArea::DisplayUmbrellas()
{
	glPushMatrix();

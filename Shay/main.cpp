...
void CreateBoundingBoxesExtendedArea()
{
	...
	cam.AddAABB(glm::vec3(-4622, 0, 5875), glm::vec3(-5072, 0, 2875)); //First tree/bush section on row 1
	cam.AddAABB(glm::vec3(-5072, 0, 5875), glm::vec3(-5522, 0, 5125)); //First tree/bush section on row 2
...
{	
	...
	// top of higher hill
	cam.AddPlain(FLAT_PLAIN, glm::vec3(14000, 10875, 28000), glm::vec3(18000, 108075, 33000));
...
void CreatePlainsExtendedArea()
{
	...
	cam.AddPlain(FLAT_PLAIN, glm::vec3(-9296, 9430, 1421), glm::vec3(-7874, 9430, 10540));
